...
class RobotState {
    ...
    public:
        ...
        const Eigen::Vector3d getDisturbanceContactVel() const;
        ...
        void setDisturbanceContactVel(const Eigen::Vector3d& d); // disturbance left wheel
        ...
        void setDisturbanceContactVelCovariance(const Eigen::Matrix3d& cov);
