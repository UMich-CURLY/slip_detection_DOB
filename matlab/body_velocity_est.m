...
bagFile = rosbag('/media/xihang/761C73981C7351DB/husky_rosbag/rosbag_data/slip_detect/mars_sand2.bag');
%% Read from Orb-SLAM3
...
est_pose_baseline = load("/home/xihang/Code/slip_detector_test(world_frame)/catkin_ws/src/slip_detector/data/2022-slip_detection/mars_sand2_no_disturbance/inekf_wheel_vel.txt");
...
vel_est_no_disturbance = load("/home/xihang/Code/slip_detector_test(world_frame)/catkin_ws/src/slip_detector/data/2022-slip_detection/mars_sand2_no_disturbance/wheel_vel_est.txt");
...
plot(vel_est_no_disturbance(1:end,1)-vel_est_no_disturbance(1,1),vel_est_no_disturbance(:,6),'b-.','LineWidth',1.3);
plot(vel_est(1:end,1)-vel_est(1,1),vel_est(:,6),'r-.','LineWidth',1.3);
xlabel('$t \; (s)$', 'fontsize', fsize, 'Interpreter','latex')
...
plot(vel_est_no_disturbance(1:end,1)-vel_est_no_disturbance(1,1),vel_est_no_disturbance(:,7),'b-.','LineWidth',1.3);
plot(vel_est(1:end,1)-vel_est(1,1),vel_est(:,7),'r-.','LineWidth',1.3);
xlabel('$t \; (s)$', 'fontsize', fsize, 'Interpreter','latex')
